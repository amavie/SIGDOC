...
class Sigdoc extends CI_Controller {
    ...
    public function index() {
        ...
        $this->data['saidas'] = $this->Correspondencias_model->saidas();   
        $this->data['entradas'] = $this->Correspondencias_model->entradas();
        $this->data['pareceres'] = $this->Correspondencias_model->pareceres();   
        $this->data['despachos'] = $this->Correspondencias_model->despachos();  
        $this->data['totalDirecoes'] = $this->Correspondencias_model->totalDirecoes();      
        $this->data['totalDirecoesSaida'] = $this->Correspondencias_model->totalDirecoesSaida();
        $this->data['totalDirecoesPareceres'] = $this->Correspondencias_model->totalDirecoesPareceres();
        $this->data['totalDirecoesDespacho'] = $this->Correspondencias_model->totalDirecoesDespacho();
        $this->data['chartTotalDiario'] = $this->Correspondencias_model->chartTotalDiario();
        $this->data['chartTotalDespacho'] = $this->Correspondencias_model->chartTotalDespacho();   
        $this->data['chartTotalDirecao'] = $this->Correspondencias_model->chartTotalDirecao();




       
        $this->data['menuPainel'] = 'Dashboard';
        $this->load->view('tema/topo',  $this->data);
        $this->load->view('sigdoc/painel');
