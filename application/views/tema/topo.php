...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="<?php echo base_url(); ?>assets/login/images/misau.png" alt="Ministério da Saúde" height="80" width="80">
  </div>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link"><?php echo $menuPainel; ?></a>
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
       <a class="nav-link"  href="<?php echo base_url()?>index.php/sigdoc/sair"  >
   ...
   <!--  <a href="index3.html" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?php echo base_url(); ?>assets/login/images/misau.png" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a  class="d-block"><?php echo $this->session->userdata('nome');?></a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'vCorrespondencia')){ ?>
              <li class="nav-item">
                <a href="<?php echo base_url()?>index.php/correspondencias/gerenciar" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p><small> Correspondência </small>Ostensiva</p>
                </a>
              </li>
               <?php } ?>
               ...
               <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'vCorrespondencia')){ ?>
              <li class="nav-item">
                <a href="<?php echo base_url()?>index.php/correspondencias/listaSigiloso" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p><small> Correspondência </small>Sigilosa</p>
                </a>
              </li>
              <?php } ?>
            ...
            <a href="#" class="nav-link">
              ...
              <p>
                ...
                if ($direcoes<>" " and $departamentos==0 and $reparticoes==0) {  
                  echo $this->session->userdata('abrev_direcoes');}
                  
                  else if ($direcoes<>" " and $departamentos<>" " and $reparticoes==0) {    
                  echo $this->session->userdata('abrev_departamentos'); 
                  }
                  
                  else if ($direcoes<>" " and $departamentos<>" " and $reparticoes<>" ") {    
                  echo $this->session->userdata('abrev_reparticoes');}
                 ?>
                <i class="fas fa-angle-left right"></i>
              </p>
            </a>
          ...
          <li class="nav-header">Parametrização</li>
          <li class="nav-item">
            <a href="#" class="nav-link">
