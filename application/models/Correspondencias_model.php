...
// Charts Visualizacoes
 function chartTotalDiario($perpage=0,$start=0,$one=false){
     $query = $this->db->query("SELECT COUNT(numCorrespondencia) as total, data_normal as data FROM correspondencias WHERE (data_normal>=now() - INTERVAL 1 month) GROUP BY data_normal");
...
// Charts Visualizacoes
 function chartTotalDirecao($perpage=0,$start=0,$one=false){
     $query = $this->db->query("SELECT COUNT(numCorrespondencia) as total, direcoes.abreviatura direcao FROM correspondencias INNER JOIN direcoes ON direcoes.id=correspondencias.local_direcoes_id 
WHERE (data_normal>=now() - INTERVAL 1 month) GROUP BY  direcoes.nome");
...
// Charts Visualizacoes
 function chartTotalDespacho($perpage=0,$start=0,$one=false){
     $query = $this->db->query("SELECT COUNT(despacho.id) as total, direcoes.abreviatura direcao FROM despacho INNER JOIN direcoes ON direcoes.id=despacho.direcoes_id WHERE (data_despacho>=now() - INTERVAL 6 month) GROUP BY  direcoes.nome");
...
// Dashboard cidadaos
 function entradas($perpage=0,$start=0,$one=false){
     $query = $this->db->query("SELECT count(numCorrespondencia) as total FROM correspondencias where categorias_id=1  ");
...
// Dashboard cidadaos
 function saidas($perpage=0,$start=0,$one=false){
     $query = $this->db->query("SELECT count(numCorrespondencia) as total FROM correspondencias where categorias_id=2  ");
...
// Dashboard cidadaos
 function pareceres($perpage=0,$start=0,$one=false){
     $query = $this->db->query("SELECT count(id) as total FROM parecer   ");
...
// Dashboard cidadaos
 function despachos($perpage=0,$start=0,$one=false){
     $query = $this->db->query("SELECT count(id) as total FROM despacho   ");
...
// Dashboard correspondencias por direcoes
 function totalDirecoes($perpage=0,$start=0,$one=false){
     $query = $this->db->query("SELECT direcoes.nome as direcao, count(numCorrespondencia) as total FROM direcoes inner join correspondencias on correspondencias.local_direcoes_id = direcoes.id where categorias_id=1 group by direcoes.nome order by total desc  ");
...
// Dashboard correspondencias por direcoes
 function totalDirecoesSaida($perpage=0,$start=0,$one=false){
     $query = $this->db->query("SELECT direcoes.nome as direcao, count(numCorrespondencia) as total FROM direcoes inner join correspondencias on correspondencias.local_direcoes_id = direcoes.id where categorias_id=2 group by direcoes.nome order by total desc  ");
...
// Dashboard correspondencias por direcoes
 function totalDirecoesPareceres($perpage=0,$start=0,$one=false){
     $query = $this->db->query("SELECT direcoes.nome as direcao, count(parecer.id) as total FROM direcoes inner join parecer on parecer.direcoes_id = direcoes.id  group by direcoes.nome order by total desc  ");
...
// Dashboard correspondencias por direcoes
 function totalDirecoesDespacho($perpage=0,$start=0,$one=false){
     $query = $this->db->query("SELECT direcoes.nome as direcao, count(despacho.id) as total FROM direcoes inner join despacho on despacho.direcoes_id = direcoes.id  group by direcoes.nome order by total desc");
 ...
 function getDespachoGabinete($perpage=0,$start=0,$one=false){
        
        $this->db->from('despacho');
        $this->db->select('despacho.*, correspondencias.numcorrespondencia as correspondencias');
        $this->db->select('despacho.*, correspondencias.pro_direcoes_id as pro_direcoes_id'); 
        $this->db->select('despacho.*, correspondencias.assunto as assunto');    
        $this->db->select('despacho.*, correspondencias.data_normal as data_entrada');
        $this->db->select('despacho.*, correspondencias.refProv as refProv');  
        $this->db->select('despacho.*, direcoes.abreviatura as prov');

        $this->db->where('direcoes_id',13);
        $this->db->order_by("data_normal","asc");
        $this->db->limit($perpage,$start);
        $this->db->join('correspondencias', 'correspondencias.id = despacho.correspondencias_id', 'left');$this->db->join('direcoes', 'direcoes.id = despacho.direcoes_id', 'left');
 ...
 function get($perpage=0,$start=0,$one=false){
  ...
  function getEstadosDespacho($perpage=0,$start=0,$one=false){
     ...
     function getTramitar($perpage=0,$start=0,$one=false){
        ...
        $this->db->select('tramitar.*, correspondencias.estadoRec as estadosRec');
        $this->db->order_by("id","DESC");
        $this->db->limit($perpage,$start);
